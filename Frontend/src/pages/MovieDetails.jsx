...
function MovieDetails() {
  ...
  const getShow=()=>{
    const films=dummyShowsData.find((film)=>film._id===id);
    if (films){
      setShow({
      movie:films,
  ...
  return show?(
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        <img src={show.movie.poster_path} alt="" className="max-md:mx-auto rounded-xl h-104 max-w-70 object-cover"></img>
